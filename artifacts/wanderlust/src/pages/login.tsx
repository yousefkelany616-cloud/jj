...
export default function Login() {
  ...
  const onSubmit = async (values: z.infer<typeof loginSchema>) => {
    try {
      ...
      toast({ title: "Welcome to Atlas Adventures!" });
      setLocation("/dashboard");
    } catch (e) {
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="max-w-md text-white text-center">
            <img
              ...
              className="h-28 md:h-32 w-auto mx-auto mb-8 object-contain drop-shadow-lg"
            />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="email" placeholder="explorer@atlasadventures.com" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
