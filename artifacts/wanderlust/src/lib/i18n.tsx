...
const en: Dict = {
  ...
  "home.types.title": "Choose Your Adventure",
  "home.types.subtitle": "From the depths of the Red Sea to the peaks of Sinai",
  "home.types.explore": "Explore",
  "home.types.diving": "Diving",
  "home.types.hiking": "Hiking",
  "home.types.snorkeling": "Snorkeling",
  "home.types.camping": "Camping",
  "home.types.safari": "Safari",
  "home.stats.title": "Why Egypt",
  "home.stats.subtitle": "One country, every kind of adventure",
  "home.stats.adventures": "Hand-picked adventures",
  "home.stats.types": "Activity types",
  "home.stats.coast": "km of Red Sea coast",
  "home.stats.season": "Best season",
  "home.essentials.title": "Plan Your Trip",
  "home.essentials.subtitle": "Everything you need to know before you go",
  "home.essentials.season.title": "Best Time to Visit",
  "home.essentials.season.body": "October to April brings cooler desert nights and calm Red Sea waters. Avoid mid-summer in the south.",
  "home.essentials.currency.title": "Currency & Cost",
  "home.essentials.currency.body": "Egyptian Pound (EGP). Adventures range from $75 day trips to $480 multi-day desert expeditions.",
  "home.essentials.safety.title": "Safety & Help",
  "home.essentials.safety.body": "Tourist Police 126 · Ambulance 123 · Police 122. Bedouin guides are required for Sinai and desert treks.",
...
const ar: Dict = {
  ...
  "home.types.title": "اختر مغامرتك",
  "home.types.subtitle": "من أعماق البحر الأحمر إلى قمم سيناء",
  "home.types.explore": "استكشاف",
  "home.types.diving": "غوص",
  "home.types.hiking": "تسلق",
  "home.types.snorkeling": "غطس بالأنبوب",
  "home.types.camping": "تخييم",
  "home.types.safari": "سفاري",
  "home.stats.title": "لماذا مصر",
  "home.stats.subtitle": "بلد واحد، كل أنواع المغامرات",
  "home.stats.adventures": "مغامرة مختارة بعناية",
  "home.stats.types": "أنواع النشاطات",
  "home.stats.coast": "كم من ساحل البحر الأحمر",
  "home.stats.season": "أفضل موسم",
  "home.essentials.title": "خطّط لرحلتك",
  "home.essentials.subtitle": "كل ما تحتاج معرفته قبل السفر",
  "home.essentials.season.title": "أفضل وقت للزيارة",
  "home.essentials.season.body": "من أكتوبر إلى أبريل: ليالي صحراوية أبرد ومياه هادئة في البحر الأحمر. تجنّب منتصف الصيف في الجنوب.",
  "home.essentials.currency.title": "العملة والتكلفة",
  "home.essentials.currency.body": "الجنيه المصري (EGP). تتراوح المغامرات من 75 دولار لرحلات اليوم الواحد إلى 480 دولار للرحلات الصحراوية متعددة الأيام.",
  "home.essentials.safety.title": "الأمان والمساعدة",
  "home.essentials.safety.body": "شرطة السياحة 126 · الإسعاف 123 · الشرطة 122. مرشدون بدو مطلوبون لرحلات سيناء والصحراء.",
